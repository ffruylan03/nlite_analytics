...
public class TIterateToFlowOutBeginJava
{
  ...
  protected final String TEXT_34 = NL + "OnSubjobOkStruct";
  protected final String TEXT_35 = " struct_";
  protected final String TEXT_36 = " = new OnSubjobOkStruct";
  protected final String TEXT_37 = "();";
  protected final String TEXT_38 = NL + "struct_";
  protected final String TEXT_39 = "  = ";
  protected final String TEXT_40 = ";";
  protected final String TEXT_41 = NL + "\tlog.trace(\"struct_";
  protected final String TEXT_42 = " - \" + struct_";
  protected final String TEXT_43 = ".toLogString());";
  protected final String TEXT_44 = NL;
  protected final String TEXT_45 = NL + "\t";
  protected final String TEXT_46 = NL + "\t\tsynchronized (";
  protected final String TEXT_47 = ".this.globalMap) {" + NL + "\t";
  protected final String TEXT_48 = ".this.obj) {" + NL + "\t";
  protected final String TEXT_49 = NL + "\t\t    if(";
  protected final String TEXT_50 = ".this.globalMap.containsKey(\"";
  protected final String TEXT_51 = "\")){" + NL + "\t\t    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_52 = "> list_";
  protected final String TEXT_53 = " = (java.util.List<OnSubjobOkStruct";
  protected final String TEXT_54 = ">)";
  protected final String TEXT_55 = ".this.globalMap.get(\"";
  protected final String TEXT_56 = "\"); " + NL + "\t\t    \tlist_";
  protected final String TEXT_57 = ".add(struct_";
  protected final String TEXT_58 = ");" + NL + "\t\t    }else{" + NL + "\t\t    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_59 = " = java.util.Collections.synchronizedList(new java.util.ArrayList<OnSubjobOkStruct";
  protected final String TEXT_60 = ">());" + NL + "\t\t    \tlist_";
  protected final String TEXT_61 = ");" + NL + "\t\t    \t";
  protected final String TEXT_62 = ".this.globalMap.put(\"";
  protected final String TEXT_63 = "\",list_";
  protected final String TEXT_64 = ");" + NL + "\t\t    }" + NL + "\t\t}";
  protected final String TEXT_65 = NL + "    if(globalMap.get(\"";
  protected final String TEXT_66 = "\") != null){" + NL + "    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_67 = ">)globalMap.get(\"";
  protected final String TEXT_68 = "\"); " + NL + "    \tlist_";
  protected final String TEXT_69 = ");" + NL + "    }else{" + NL + "    \tjava.util.List<OnSubjobOkStruct";
  protected final String TEXT_70 = " = new java.util.ArrayList<OnSubjobOkStruct";
