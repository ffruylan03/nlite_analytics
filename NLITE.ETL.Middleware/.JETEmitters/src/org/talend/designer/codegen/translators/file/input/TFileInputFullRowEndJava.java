...
public class TFileInputFullRowEndJava
{
  ...
  protected final String TEXT_22 = NL + NL + "            }" + NL + "           \t}finally{" + NL + "           \t\tif(fid_";
  protected final String TEXT_23 = "!=null){" + NL + "            \t\tfid_";
  protected final String TEXT_24 = ".close();" + NL + "            \t}" + NL + "            }" + NL + "            globalMap.put(\"";
  protected final String TEXT_25 = "_NB_LINE\", fid_";
  protected final String TEXT_26 = ".getRowNumber());";
