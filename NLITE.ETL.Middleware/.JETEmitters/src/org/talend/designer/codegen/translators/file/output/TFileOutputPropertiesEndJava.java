...
public class TFileOutputPropertiesEndJava
{
  ...
  protected final String TEXT_22 = NL + "\tjava.io.OutputStream fos_";
  protected final String TEXT_23 = " = new java.io.FileOutputStream(file_";
  protected final String TEXT_24 = ");" + NL + "\tproperties_";
  protected final String TEXT_25 = ".store(fos_";
  protected final String TEXT_26 = ", \"\");" + NL + "\tfos_";
  protected final String TEXT_27 = ".close();";
  protected final String TEXT_28 = NL + "\tini_";
  protected final String TEXT_29 = ".store();";
  protected final String TEXT_30 = NL + "int nb_line_";
  protected final String TEXT_31 = " = tos_count_";
