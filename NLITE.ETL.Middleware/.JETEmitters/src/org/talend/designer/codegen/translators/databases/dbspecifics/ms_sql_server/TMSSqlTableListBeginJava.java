...
public class TMSSqlTableListBeginJava
{
  ...
  protected final String TEXT_62 = NL + "String dbSchema_";
  protected final String TEXT_63 = " = (String)globalMap.get(\"";
  protected final String TEXT_64 = "\");" + NL + "" + NL + "String whereClause_";
  protected final String TEXT_65 = " = ";
  protected final String TEXT_66 = ";" + NL + "" + NL + "String query_";
  protected final String TEXT_67 = " = \"\";" + NL + "" + NL + "if(dbSchema_";
  protected final String TEXT_68 = " != null && dbSchema_";
  protected final String TEXT_69 = ".length() > 0){" + NL + "\t" + NL + "\tquery_";
  protected final String TEXT_70 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type='BASE TABLE' AND table_schema='\" + dbSchema_";
  protected final String TEXT_71 = " + \"'\";" + NL + "\t" + NL + "}else{" + NL + "\t" + NL + "\tquery_";
  protected final String TEXT_72 = " = \"SELECT table_name FROM information_schema.tables WHERE table_type='BASE TABLE'\";" + NL + "\t" + NL + "}" + NL + "if(whereClause_";
  protected final String TEXT_73 = " != null && whereClause_";
  protected final String TEXT_74 = ".length() > 0){" + NL + "" + NL + "\tquery_";
  protected final String TEXT_75 = " = query_";
  protected final String TEXT_76 = " + \" AND (\" + whereClause_";
  protected final String TEXT_77 = " + \") ORDER BY table_name ASC\";" + NL + "" + NL + "}else{" + NL + "" + NL + "\tquery_";
  protected final String TEXT_78 = " + \" ORDER BY table_name ASC\";" + NL + "" + NL + "}";
  protected final String TEXT_79 = NL + "    log.info(\"";
  protected final String TEXT_80 = " - Query:'\"+query_";
  protected final String TEXT_81 = "+\"'.\");";
  protected final String TEXT_82 = NL + NL + "int nb_table_";
  protected final String TEXT_83 = " = 0;" + NL + "" + NL + "java.sql.Statement stmt2_";
  protected final String TEXT_84 = " = conn_";
  protected final String TEXT_85 = ".createStatement();" + NL + "" + NL + "java.sql.ResultSet rs_";
  protected final String TEXT_86 = " = stmt2_";
  protected final String TEXT_87 = ".executeQuery(query_";
  protected final String TEXT_88 = ");" + NL + "" + NL + "while (rs_";
  protected final String TEXT_89 = ".next()) {" + NL + "" + NL + "\tString currentTableName_";
  protected final String TEXT_90 = " = rs_";
  protected final String TEXT_91 = ".getString(1); " + NL + "" + NL + "\tnb_table_";
  protected final String TEXT_92 = "++;" + NL + "        " + NL + "\t";
  protected final String TEXT_93 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_94 = " - Retrieving the table \"+nb_table_";
  protected final String TEXT_95 = "+\".\");" + NL + "\t\tlog.trace(\"";
  protected final String TEXT_96 = " - Name of table \"+nb_table_";
  protected final String TEXT_97 = "+\":\"+currentTableName_";
  protected final String TEXT_98 = "+\".\");" + NL + "\t";
  protected final String TEXT_99 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_100 = "_CURRENT_TABLE\", currentTableName_";
