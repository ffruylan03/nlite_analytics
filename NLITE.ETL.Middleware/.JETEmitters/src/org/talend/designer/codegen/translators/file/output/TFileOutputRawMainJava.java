...
public class TFileOutputRawMainJava
{
  ...
  protected final String TEXT_20 = " instanceof java.io.InputStream) {" + NL + "\t\t\t\t\t\t\tjava.io.InputStream fis_";
  protected final String TEXT_21 = " = (java.io.InputStream) content_";
  protected final String TEXT_22 = ";" + NL + "\t\t\t\t\t\t\tjava.io.FileOutputStream fos_";
  protected final String TEXT_23 = " = new java.io.FileOutputStream(file_";
  protected final String TEXT_24 = ");" + NL + "\t\t\t\t\t\t\tbyte[] buffer_";
  protected final String TEXT_25 = " = new byte[65536];" + NL + "\t\t\t\t\t\t\tint nb_";
  protected final String TEXT_26 = " = 0;" + NL + "\t\t\t\t\t\t\twhile (true) {" + NL + "\t\t\t\t\t\t\t      nb_";
  protected final String TEXT_27 = " = fis_";
  protected final String TEXT_28 = ".read(buffer_";
  protected final String TEXT_29 = ");" + NL + "\t\t\t\t\t\t\t      if (nb_";
  protected final String TEXT_30 = " == -1) {" + NL + "\t\t\t\t\t\t\t      \t break;" + NL + "\t\t\t\t\t\t\t      }\t\t " + NL + "\t\t\t\t\t\t\t      fos_";
  protected final String TEXT_31 = ".write(buffer_";
  protected final String TEXT_32 = ", 0, nb_";
  protected final String TEXT_33 = ");" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tfis_";
  protected final String TEXT_34 = ".close();" + NL + "\t\t\t\t\t\t\tfos_";
  protected final String TEXT_35 = ".close();" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t    org.apache.commons.io.FileUtils.writeStringToFile(file_";
  protected final String TEXT_36 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} catch (java.lang.Exception e_";
  protected final String TEXT_37 = ") {" + NL + "globalMap.put(\"";
  protected final String TEXT_38 = "_ERROR_MESSAGE\",e_";
  protected final String TEXT_39 = ".getMessage());";
  protected final String TEXT_40 = NL + "\t\t\t\t\t\tthrow e_";
