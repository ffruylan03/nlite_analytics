...
public class TFileInputRawEndJava
{
  ...
  protected final String TEXT_5 = "_ERROR_MESSAGE\",e_";
  protected final String TEXT_6 = ".getMessage());";
  protected final String TEXT_7 = NL + "\t\t\t\t\t\tthrow e_";
  protected final String TEXT_8 = ";";
  protected final String TEXT_9 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_10 = NL + "\t\t\t\t\t\tlog.error(\"";
  protected final String TEXT_11 = " - \" +e_";
  protected final String TEXT_12 = ".getMessage());" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_13 = NL + "\t\t\t\t\t\tSystem.err.println(e_";
