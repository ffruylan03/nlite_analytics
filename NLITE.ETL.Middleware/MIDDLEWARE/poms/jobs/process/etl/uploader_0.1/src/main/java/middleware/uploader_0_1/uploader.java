...
package middleware.uploader_0_1;
 ...
 * @status
 */
public class uploader implements TalendJob {
	...
	private final String jobName = "uploader";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(uploader.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class OnSubjobOkStructtIterateToFlow_1
		...
		final static byte[] commonByteArrayLock_MIDDLEWARE_uploader = new byte[0];
		static byte[] commonByteArray_MIDDLEWARE_uploader = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MIDDLEWARE_uploader.length) {
					if (length < 1024 && commonByteArray_MIDDLEWARE_uploader.length == 0) {
						commonByteArray_MIDDLEWARE_uploader = new byte[1024];
					} else {
						commonByteArray_MIDDLEWARE_uploader = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MIDDLEWARE_uploader, 0, length);
				strReturn = new String(commonByteArray_MIDDLEWARE_uploader, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_MIDDLEWARE_uploader, 0, length);
				strReturn = new String(commonByteArray_MIDDLEWARE_uploader, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MIDDLEWARE_uploader) {
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String directory_tFileList_1 = "C:/Users/Fermin/Projects/pif/repos/nlite_analytics/NLITE.ETL.Middleware/data/dump";
	...
	public void tFixedFlowInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "file_name", "file_path", "status", });
...
///////////////////////    			
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					row3.file_name = ((String) globalMap.get("tFileList_1_CURRENT_FILE"));

					row3.file_path = ((String) globalMap.get("tFileList_1_CURRENT_FILEPATH"));

					row3.status = ((String) globalMap.get("status"));
...
///////////////////////		
					...
					if (row3.file_name != null) { //
						row_tLogRow_1[0] = String.valueOf(row3.file_name);

					} //

					if (row3.file_path != null) { //
						row_tLogRow_1[1] = String.valueOf(row3.file_path);

					} //

					if (row3.status != null) { //
						row_tLogRow_1[2] = String.valueOf(row3.status);
...
///////////////////////    			
	...
	public static class upload_files_outStruct implements routines.system.IPersistableRow<upload_files_outStruct> {
		final static byte[] commonByteArrayLock_MIDDLEWARE_uploader = new byte[0];
		static byte[] commonByteArray_MIDDLEWARE_uploader = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(upload_files_outStruct other) {
	...
	public void tIterateToFlow_1_AIProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				upload_files_outStruct upload_files_out = new upload_files_outStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "upload_files_out");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("uploaded_files");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("uploaded_files");
				}
				...
				String url_tDBOutput_1 = "jdbc:postgresql://" + "localhost" + ":" + "5432" + "/" + "nliteetldb";
				dbUser_tDBOutput_1 = "postgres";

				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:bC/zwp57fjUxP3G5rRqUR4JdquVuI6crxiP+fZwVs5y+Ooc8qg==");
...
// # Outputs initialization
				upload_files_outStruct upload_files_out_tmp = new upload_files_outStruct();
// ###############################
				...
				for (OnSubjobOkStructtIterateToFlow_1 row_tIterateToFlow_1_AI : list_tIterateToFlow_1_AI) {
					...
					row2.file_name = row_tIterateToFlow_1_AI.file_name;

					row2.file_path = row_tIterateToFlow_1_AI.file_path;
					...
					{ // start of Var scope
						...
						upload_files_out = null;

// # Output table : 'upload_files_out'
						upload_files_out_tmp.file_name = row2.file_name;
						upload_files_out_tmp.status = Var.status;
						upload_files_out = upload_files_out_tmp;
// ###############################
					 ...
					 */
// Start of branch "upload_files_out"
					if (upload_files_out != null) {
						...
						if (upload_files_out.file_name == null) {
							pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(1, upload_files_out.file_name);
						}

						if (upload_files_out.status == null) {
							pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(2, upload_files_out.status);
						}
					...
					} // End of branch "upload_files_out"
				...
				if (((String) globalMap.get("status")) != "success") {
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "upload_files_out");
				}
	...
	public static void main(String[] args) {
		final uploader uploaderClass = new uploader();

		int exitCode = uploaderClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = uploader.class.getClassLoader()
					.getResourceAsStream("middleware/uploader_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = uploader.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					if (context.getStringValue("status") == null) {
						context.status = null;
					} else {
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : uploader");
		}
...
/************************************************************************************************
 * 84195 characters generated by Talend Open Studio for Data Integration on the
 * March 2, 2023 at 12:09:44 PM EST
 ************************************************************************************************/