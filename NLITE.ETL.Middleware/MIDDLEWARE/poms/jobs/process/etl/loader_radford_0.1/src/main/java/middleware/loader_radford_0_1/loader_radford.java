		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					String url_tDBOutput_2 = "jdbc:postgresql://" + context.server + ":" + context.server_port + "/"
							+ context.database;
					...
					try {
						...
						while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
							...
							try {
								...
								row1.Event_Date = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1)
										.trim();

								columnIndexWithD_tFileInputDelimited_1 = 1;

								row1.Event_Description = fid_tFileInputDelimited_1
										.get(columnIndexWithD_tFileInputDelimited_1).trim();

								columnIndexWithD_tFileInputDelimited_1 = 2;

								row1.Player_Name = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1)
										.trim();

								columnIndexWithD_tFileInputDelimited_1 = 3;

								row1.Event_Type = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1)
										.trim();

								columnIndexWithD_tFileInputDelimited_1 = 4;

								row1.Event_Location = fid_tFileInputDelimited_1
										.get(columnIndexWithD_tFileInputDelimited_1).trim();

								columnIndexWithD_tFileInputDelimited_1 = 5;

								row1.Event_Result = fid_tFileInputDelimited_1
										.get(columnIndexWithD_tFileInputDelimited_1).trim();

								columnIndexWithD_tFileInputDelimited_1 = 6;

								row1.Event_Tags = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1)
										.trim();

								columnIndexWithD_tFileInputDelimited_1 = 7;

								row1.Segment_Name = fid_tFileInputDelimited_1
										.get(columnIndexWithD_tFileInputDelimited_1).trim();
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												...
												"Performance_Duration__min", "row1", temp, ex_tFileInputDelimited_1),
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Total_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Walk_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Jog_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Run_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Sprint_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Sprint_Efforts", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Zone_1_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Zone_2_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Zone_3_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Zone_4_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Zone_5_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Zone_6_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Zone_7_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Zone_8_Distance__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Hard_Running__m", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Hard_Running_Efforts", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Work_Rate__m_min", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Top_Speed__m_s", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Intensity", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Impact_Light", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Impact_Medium", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Impact_Heavy", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Load_2D", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Load_3D", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"HR_Mean__bpm", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"HR_Max__bpm", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"HR_Grey_Zone", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"HR_Blue_Zone", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"HR_Green_Zone", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"HR_Yellow_Zone", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"HR_Red_Zone", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
								...
								if (temp.length() > 0) {
									...
									try {
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"HR_Efficiency__m_beat", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
...
// Start of branch "map_out"
								if (map_out != null) {
									...
									if (map_out.event_date == null) {
										...
										pstmt_tDBOutput_2.setString(2, map_out.event_date);
									}

									if (map_out.event_description == null) {
										pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(3, map_out.event_description);
									}

									if (map_out.player_name == null) {
										pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(4, map_out.player_name);
									}

									if (map_out.event_type == null) {
										pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(5, map_out.event_type);
									}

									if (map_out.event_location == null) {
										pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(6, map_out.event_location);
									}

									if (map_out.event_result == null) {
										pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(7, map_out.event_result);
									}

									if (map_out.event_tags == null) {
										pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(8, map_out.event_tags);
									}

									if (map_out.segment_name == null) {
										pstmt_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_2.setString(9, map_out.segment_name);
									}
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = loader_radford.class.getClassLoader()
					.getResourceAsStream("middleware/loader_radford_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = loader_radford.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : loader_radford");
		}
...
/************************************************************************************************
 * 144356 characters generated by Talend Open Studio for Data Integration on the
 * March 12, 2023 at 3:29:21 PM EDT
 ************************************************************************************************/