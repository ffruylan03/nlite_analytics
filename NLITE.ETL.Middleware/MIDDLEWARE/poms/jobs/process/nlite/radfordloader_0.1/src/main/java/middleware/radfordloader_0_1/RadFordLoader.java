...
package middleware.radfordloader_0_1;
 ...
 * @status
 */
public class RadFordLoader implements TalendJob {
	...
	private final String jobName = "RadFordLoader";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					RadFordLoader.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(RadFordLoader.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_MIDDLEWARE_RadFordLoader = new byte[0];
		static byte[] commonByteArray_MIDDLEWARE_RadFordLoader = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MIDDLEWARE_RadFordLoader.length) {
					if (length < 1024 && commonByteArray_MIDDLEWARE_RadFordLoader.length == 0) {
						commonByteArray_MIDDLEWARE_RadFordLoader = new byte[1024];
					} else {
						commonByteArray_MIDDLEWARE_RadFordLoader = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MIDDLEWARE_RadFordLoader, 0, length);
				strReturn = new String(commonByteArray_MIDDLEWARE_RadFordLoader, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_MIDDLEWARE_RadFordLoader, 0, length);
				strReturn = new String(commonByteArray_MIDDLEWARE_RadFordLoader, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MIDDLEWARE_RadFordLoader) {
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String directory_tFileList_1 = "C:/Users/Fermin/Projects/pif/repos/nlite_analytics/NLITE.ETL.Middleware/dump";
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					if (execStat) {
						runStat.updateStatOnConnection("iterate1", 1, "exec" + NB_ITERATE_tFileInputFullRow_1);
						// Thread.sleep(1000);
					}
					...
					util_tLogRow_1.addRow(new String[] { "line", });
...
///////////////////////		
							...
							if (row1.line != null) { //
								row_tLogRow_1[0] = String.valueOf(row1.line);
...
///////////////////////    			
					...
					if (execStat) {
						runStat.updateStatOnConnection("iterate1", 2, "exec" + NB_ITERATE_tFileInputFullRow_1);
					}
	...
	public static void main(String[] args) {
		final RadFordLoader RadFordLoaderClass = new RadFordLoader();

		int exitCode = RadFordLoaderClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = RadFordLoader.class.getClassLoader()
					.getResourceAsStream("middleware/radfordloader_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = RadFordLoader.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : RadFordLoader");
		}
...
/************************************************************************************************
 * 44656 characters generated by Talend Open Studio for Data Integration on the
 * February 26, 2023 at 6:35:54 PM EST
 ************************************************************************************************/