...
package middleware.expression_builder_rowgenerator2;
...
public class Expression_builder_RowGenerator2 implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_MIDDLEWARE_Expression_builder_RowGenerator2 = new byte[0];
		static byte[] commonByteArray_MIDDLEWARE_Expression_builder_RowGenerator2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MIDDLEWARE_Expression_builder_RowGenerator2.length) {
					if (length < 1024 && commonByteArray_MIDDLEWARE_Expression_builder_RowGenerator2.length == 0) {
						commonByteArray_MIDDLEWARE_Expression_builder_RowGenerator2 = new byte[1024];
					} else {
						commonByteArray_MIDDLEWARE_Expression_builder_RowGenerator2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MIDDLEWARE_Expression_builder_RowGenerator2, 0, length);
				strReturn = new String(commonByteArray_MIDDLEWARE_Expression_builder_RowGenerator2, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_MIDDLEWARE_Expression_builder_RowGenerator2, 0, length);
				strReturn = new String(commonByteArray_MIDDLEWARE_Expression_builder_RowGenerator2, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MIDDLEWARE_Expression_builder_RowGenerator2) {
...
///////////////////////		
					...
					if (globalMap.get("tLogRow_CONSOLE") != null) {
						consoleOut_tLogRow = (java.io.PrintStream) globalMap.get("tLogRow_CONSOLE");
					} else {
						consoleOut_tLogRow = new java.io.PrintStream(new java.io.BufferedOutputStream(System.out));
...
///////////////////////    			
					...
					/**
					 * [tLogRow process_data_begin ] start
					 */

					currentComponent = "tLogRow";

					/**
					 * [tLogRow process_data_begin ] stop
					 */

					/**
					 * [tLogRow process_data_end ] start
					 */

					currentComponent = "tLogRow";

					/**
					 * [tLogRow process_data_end ] stop
					 */
...
///////////////////////    			
			...
			try {
				...
				/**
				 * [tLogRow finally ] start
				 */

				currentComponent = "tLogRow";

				/**
				 * [tLogRow finally ] stop
				 */
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Expression_builder_RowGenerator2.class.getClassLoader().getResourceAsStream(
					"middleware/expression_builder_rowgenerator2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Expression_builder_RowGenerator2.class.getClassLoader()
...
/************************************************************************************************
 * 34056 characters generated by Talend Open Studio for Data Integration on the
 * March 2, 2023 at 11:11:53 AM EST
 ************************************************************************************************/